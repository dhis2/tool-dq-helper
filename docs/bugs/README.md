...
| 03  | [`03-blank-instance-analytics-empty`](03-blank-instance-analytics-empty/)                             | Largely **intended behaviour** (DHIS2-20379 opt-in data output period types) — remaining: analytics _API_ returns silent empty results where the apps show a clear "no period types enabled" message (improvement suggestion) | ✘ requires a fresh empty install |
